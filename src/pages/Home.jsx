    ...
    <main>
        ...
        <div className="about">
          <div className="reveal-left">
            ...
            <div className="about__stat-row">
              <div>
                <div className="about__stat-num">40+</div>
                <div className="about__stat-label">Fabric Weights</div>
              </div>
              <div>
                <div className="about__stat-num">12yr</div>
                <div className="about__stat-label">In the Industry</div>
              </div>
              <div>
                <div className="about__stat-num">8M+</div>
      ...
      <section className="collection">
        <div className="collection__header">
          ...
          <a href="/collection" className="collection__link">View All →</a>
        </div>
          ...
          {FABRICS.map((fabric, i) => (
            <div key={i} className={`fabric-card scale-in`} style={{ transitionDelay: `${i * 0.1}s` }}>
              ...
              <div style={{
                ...
                inset: 0,
                background: `
                  repeating-linear-gradient(0deg, transparent 0, transparent 6px, rgba(0,0,0,0.04) 6px, rgba(0,0,0,0.04) 7px),
              ...
              <div className="fabric-card__info">
                ...
                <div className="fabric-card__meta">{fabric.meta}</div>
      ...
      {/* ── PROCESS ── */}
      <section style={{ background: 'var(--off-white)', paddingTop: 'var(--space-2xl)' }}>
      ...
      <section className="cta-section">
        ...
        <div className="reveal">
          <a href="/contact" className="cta-btn"><span>Request Samples</span></a>
          <a href="/collection" className="cta-btn-outline">Browse Fabrics</a>
        </div>
      </section>
