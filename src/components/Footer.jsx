    ...
    <footer className="footer">
      <div className="footer__top">
        ...
        <div>
          ...
          <ul className="footer__links">
            <li><a href="/collection">Cotton Greige</a></li>
            <li><a href="/collection">Linen Blend</a></li>
            <li><a href="/collection">Heavy Canvas</a></li>
            <li><a href="/collection">Voile & Sheer</a></li>
            <li><a href="/collection">Custom Weave</a></li>
          </ul>
        </div>
